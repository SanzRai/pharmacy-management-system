...
public class HelloServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(page.equalsIgnoreCase("newUsers")){
            ...
            college.setPet(req.getParameter("pet"));
            college.setAim(req.getParameter("aim"));
        ...
        if(page.equalsIgnoreCase("passwordReset")){
            ...
            College college = new UserService().resetPassword(email, pet, aim, req.getSession());
...
//                httpSession.removeAttribute("userName");
        ...
        if(page.equalsIgnoreCase("newProducts")){
            ...
            String uploadPath="C:/Users/Acer/IdeaProjects/Pharmacy_Management/src/main/webapp/assets/" + fileName;
