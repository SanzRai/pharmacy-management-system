...
public class UserService {
    ...
    public void insertUser(College college) {
        ...
        String query = "insert into user(userName, password, phoneNo, email, address, role, pet, aim)" + "values(?,?,?,?,?,?,?,?)";
        PreparedStatement preparedStatement = new DBConnection().getStatement(query);
        try {
            ...
            preparedStatement.setString(7, college.getPet());
            preparedStatement.setString(8, college.getAim());
    ...
    public College resetPassword(String email, String pet, String aim, HttpSession httpSession) throws IOException {
        String query = "select * from user where email=? and pet=? or aim=?";
        PreparedStatement preparedStatement = new DBConnection().getStatement(query);
        College college = null;
